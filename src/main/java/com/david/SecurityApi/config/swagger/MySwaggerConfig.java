package com.david.SecurityApi.config.swagger;
...
public class MySwaggerConfig {
    ...
    private ApiInfo metadata() {
        return new ApiInfoBuilder().title("Security API").description("API reference guide for developers").termsOfServiceUrl("https://www.google.com/").contact("David").version("1.0").build();
    }
}
